...
/* Vynútenie bieleho textu pre čitateľnosť na čiernom */
...
try:
    ...
    with tabs[2]:
        ...
        # Logika pre zástupcu (plne dynamická podľa tabuľky Adresar)
        ...
        if je_zastupca_v_tabulke:
            ...
            def styluj_stav(row):
                bg = 'background-color: #822222; color: white;' if row['Stav'] == 'Nedoplatok' else 'background-color: #225522; color: white;'
                return [bg] * len(row)
